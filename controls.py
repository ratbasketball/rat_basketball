"""
NOTE: This controls.py file works for the NES USB controller.  It will not work with other controllers without modification.
Further, some controllers require no modification to the controls.py file in the pygame_menu library
the library could typically be found:  /home/(User Name)/.local/lib/python3.9/site-packages/pygame_menu
if you have an NES controller you can simply replace the file with this one
